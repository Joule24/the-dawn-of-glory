...
public class Entity {
    ...
    public String dialogues[] []= new String[21][21];
    ...
    public void dropMonster(Entity droppedMon) {
        ...
        for(int i = 0; i < gp.obj[1].length; i++){
            if (gp.obj[gp.currentMap][i] == null) {
                ...
                gp.monster[gp.currentMap][i] = droppedMon;
                gp.monster[gp.currentMap][i].worldX = worldX;
    ...
    public void checkShootOrNot(int rate, int shotInterval) {
         ...
         int i = new Random().nextInt(rate);
           ...
           for(int ii = 0; ii < gp.projectile[1].length; ii++) {
                int currentMap = 0;
                if(gp.projectile[currentMap][ii] == null) {
                    gp.projectile[currentMap][ii] = projectile;
                    break;
                }
           }
           shotAvailableCounter = 0;
    ...
    public void damagePlayer(int attack){
        if(gp.player.invincible == false){
            ...
            if(gp.player.guarding == true && gp.player.direction.equals(canGuardDirection)) {
                ...
                //parry
                if(gp.player.guardCounter < 20) { //set parry time. initially 10 frames
                    damage = 0;
                    gp.playSE(16);
                    setKnockBack(this, gp.player, knockBackPower);
                    offBalance = true;
                    spriteCounter -= 90 - GamePanel.difficultyStackHP; //harder = shorter stun
                } 
                else {
                    // normal guard
                    damage = 0;
    ...
    public void draw(Graphics2D g2){
        ...
        if(inCamera() == true ){
            ...
            if(type == 2 && hpBarOn == true){
                ...
                if(hpBarCounter > 600){     //after 10 second, bar disappear
                    hpBarCounter = 0;
                    hpBarOn = false;
                }
            }
