...
public final class MON_RedSlime extends Entity{
    ...
    public void setAttributes(){
        maxLife = 12 + GamePanel.difficultyStackHP;
        life = maxLife;
        attack = 4 + GamePanel.difficultyStackDMG;
        defense = 0;
    }
    ...
    public void checkDrop() {
        ...
        //SCORE ALLOCATION
        gp.ui.addMessage("Score + " + String.valueOf((int)(40 * GamePanel.scoreMultiplier)));
        GamePanel.playerScore += 40 * GamePanel.scoreMultiplier;
