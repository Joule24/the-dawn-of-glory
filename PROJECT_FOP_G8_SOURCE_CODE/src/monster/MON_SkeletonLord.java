...
public class MON_SkeletonLord extends Entity {
    ...
    public void getAttackImage() {
         ...
         int i = 5 ;
         if ( inRage == false ){
        attackUp1 = setup("/monster/skeletonlord_attack_up_1",gp.tileSize*i,gp.tileSize*i*2); //16X32
        ...
        attackRight1 = setup("/monster/skeletonlord_attack_right_1",gp.tileSize*i*2,gp.tileSize*i); //32X16
        ...
        attackLeft2 = setup("/monster/skeletonlord_attack_left_2",gp.tileSize*i*2,gp.tileSize*i);
         ...
         if ( inRage==true ){
        attackUp1 = setup("/monster/skeletonlord_phase2_attack_up_1",gp.tileSize*i,gp.tileSize*i*2); //16X32
        ...
        attackRight1 = setup("/monster/skeletonlord_phase2_attack_right_1",gp.tileSize*i*2,gp.tileSize*i); //32X16
  ...
  //@Override
    public void setAttributes(){
        maxLife = 50 + GamePanel.difficultyStackHP;
        life = maxLife;
        attack = 6 + GamePanel.difficultyStackDMG;
        defense = 0;
    }
    ...
    public void setAttributes(int difficultyStack){
    ...
    public void checkDrop() {
        ...
        //SCORE ALLOCATION
        gp.ui.addMessage("Score + " + String.valueOf((int)(1000 * GamePanel.scoreMultiplier)));
        GamePanel.playerScore += 1000 * GamePanel.scoreMultiplier;
