...
public class MON_Orc extends Entity {
    ...
    public void getAttackImage() {
        attackUp1 = setup("/monster/orc_attack_up_1", gp.tileSize, gp.tileSize * 2); //16X32
        ...
        attackRight1 = setup("/monster/orc_attack_right_1", gp.tileSize * 2, gp.tileSize); //32X16
    ...
    public void setAttributes(){
        maxLife = 15 + GamePanel.difficultyStackHP;
        life = maxLife;
        attack = 5 + GamePanel.difficultyStackDMG;
        defense = 2;
    }
    ...
    public void checkDrop() {
        ...
        //SCORE ALLOCATION
        gp.ui.addMessage("Score + " + String.valueOf((int)(100 * GamePanel.scoreMultiplier)));
        GamePanel.playerScore += 100 * GamePanel.scoreMultiplier;
